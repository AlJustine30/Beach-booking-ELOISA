            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl">
                <div class="p-8 sm:p-10 bg-white">
                    <div class="mb-8 text-center">
                        <h3 class="text-2xl font-bold text-teal-800">Edit Activity Details</h3>
                        <p class="text-teal-600 mt-2">Make changes to your scheduled adventure</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('bookings.update', $booking->id) }}" class="space-y-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="name" id="name" value="{{ $booking->name }}" required 
                                       class="focus:ring-2 focus:ring-amber-500 focus:border-teal-500 block w-full pl-10 sm:text-sm border-teal-300 rounded-lg py-3 bg-teal-50 border-2 text-teal-800 placeholder-teal-400">
                            </div>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <textarea name="description" id="description" rows="4" required
                                      class="shadow-sm focus:ring-2 focus:ring-amber-500 focus:border-teal-500 mt-1 block w-full sm:text-sm border-teal-300 rounded-lg py-3 px-4 bg-teal-50 border-2 text-teal-800 placeholder-teal-400">{{ $booking->description }}</textarea>
                        </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="date" name="booking_date" id="booking_date" value="{{ $booking->booking_date }}" required
                                           class="focus:ring-2 focus:ring-amber-500 focus:border-teal-500 block w-full pl-10 sm:text-sm border-teal-300 rounded-lg py-3 bg-teal-50 border-2 text-teal-800">
                                </div>
                            </div>
