                    ...
                    <form method="POST" action="{{ route('bookings.update', $booking->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ $booking->name }}" required
                                   class="shadow appearance-none border border-teal-300 rounded w-full py-2 px-3 bg-blue-50 text-gray-700 leading-tight focus:outline-none focus:ring-teal-500 focus:border-teal-500">
                        </div>
                        <div class="mb-4">
                            <label for="description" class="block text-teal-600 text-sm font-bold mb-2">Description</label>
                            <textarea name="description" id="description" rows="3" required
                                      class="shadow appearance-none border border-teal-300 rounded w-full py-2 px-3 bg-blue-50 text-gray-700 leading-tight focus:outline-none focus:ring-teal-500 focus:border-teal-500">{{ $booking->description }}</textarea>
                        </div>
